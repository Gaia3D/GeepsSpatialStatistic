...
#
# Created: Tue Oct 28 16:23:58 2014
...
class Ui_Form_Parameter(object):
    def setupUi(self, Form_Parameter):
        ...
        self.lbl_m_1.setGeometry(QtCore.QRect(187, 53, 101, 16))
        self.lbl_m_1.setObjectName(_fromUtf8("lbl_m_1"))
        self.edtCritcalZValue = QtGui.QLineEdit(Form_Parameter)
        self.edtCritcalZValue.setGeometry(QtCore.QRect(324, 50, 41, 20))
        ...
        self.gb_multiple.setGeometry(QtCore.QRect(4, 124, 361, 41))
        ...
        self.btnRun.setGeometry(QtCore.QRect(2, 167, 111, 31))
        font = QtGui.QFont()
        ...
        self.progressBar.setGeometry(QtCore.QRect(120, 167, 241, 16))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName(_fromUtf8("progressBar"))
        self.lbl_log = QtGui.QLabel(Form_Parameter)
        self.lbl_log.setGeometry(QtCore.QRect(120, 184, 241, 16))
        self.lbl_log.setObjectName(_fromUtf8("lbl_log"))
        self.line = QtGui.QFrame(Form_Parameter)
        self.line.setGeometry(QtCore.QRect(0, 193, 361, 16))
        ...
        self.chkContact = QtGui.QCheckBox(Form_Parameter)
        self.chkContact.setGeometry(QtCore.QRect(14, 83, 181, 16))
        self.chkContact.setChecked(True)
        self.chkContact.setTristate(False)
        self.chkContact.setObjectName(_fromUtf8("chkContact"))
        self.chkDrawMark = QtGui.QCheckBox(Form_Parameter)
        self.chkDrawMark.setGeometry(QtCore.QRect(230, 347, 61, 16))
    ...
    def retranslateUi(self, Form_Parameter):
        Form_Parameter.setWindowTitle(_translate("Form_Parameter", "Getis-Ord\'s G Statistic", None))
        ...
        item.setText(_translate("Form_Parameter", "G(d)", None))
        ...
        self.chkContact.setText(_translate("Form_Parameter", "Weight by Contact", None))
