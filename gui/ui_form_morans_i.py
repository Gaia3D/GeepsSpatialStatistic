...
#
# Created: Tue Oct 28 12:45:24 2014
...
class Ui_Form_Parameter(object):
    def setupUi(self, Form_Parameter):
        ...
        self.edtSearchDistance.setGeometry(QtCore.QRect(314, 77, 51, 20))
        ...
        self.lbl_m_1.setGeometry(QtCore.QRect(186, 53, 101, 16))
        self.lbl_m_1.setObjectName(_fromUtf8("lbl_m_1"))
        self.edtCritcalZValue = QtGui.QLineEdit(Form_Parameter)
        self.edtCritcalZValue.setGeometry(QtCore.QRect(314, 50, 51, 20))
        ...
        self.gb_multiple.setGeometry(QtCore.QRect(4, 121, 361, 41))
        ...
        self.lbl_log.setGeometry(QtCore.QRect(120, 180, 241, 20))
        self.lbl_log.setObjectName(_fromUtf8("lbl_log"))
        self.line = QtGui.QFrame(Form_Parameter)
        self.line.setGeometry(QtCore.QRect(0, 191, 361, 16))
        ...
        self.chkInverseDist = QtGui.QCheckBox(Form_Parameter)
        self.chkInverseDist.setGeometry(QtCore.QRect(11, 80, 181, 16))
        self.chkInverseDist.setChecked(True)
        self.chkInverseDist.setTristate(False)
        self.chkInverseDist.setObjectName(_fromUtf8("chkInverseDist"))
        self.chkDrawMark = QtGui.QCheckBox(Form_Parameter)
        self.chkDrawMark.setGeometry(QtCore.QRect(223, 347, 61, 16))
        self.chkDrawMark.setChecked(True)
        self.chkDrawMark.setObjectName(_fromUtf8("chkDrawMark"))
    ...
    def retranslateUi(self, Form_Parameter):
        ...
        self.chkInverseDist.setText(_translate("Form_Parameter", "Weight by Inverse Distance", None))
        self.chkDrawMark.setText(_translate("Form_Parameter", "Mark", None))
